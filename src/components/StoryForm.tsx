...
interface StoryFormProps {
  onSubmit: (data: StoryRequest) => Promise<void>;
  initialData?: Partial<StoryRequest> ;
      ...
      <div className="w-1/3 flex flex-col items-center justify-start pt-10 px-6">
        ...
        <div className="flex items-center justify-center relative w-[250px] h-[350px] shadow-lg rounded overflow-hidden">
          <label
            ...
            className="flex flex-col items-center justify-center w-[250px] h-[350px] rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100"
          >
            <div className="flex flex-col items-center justify-center pt-5 pb-6">
              <img
                src={storyPicture || "image.png"}
                alt="Portada"
      ...
      <div className="w-2/3 p-10">
        ...
        <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="bg-orange-500 hover:bg-orange-600 disabled:bg-orange-300 text-white px-6 py-2 rounded shadow"
          >
